...
const styles = StyleSheet.create({
  ...
  label:   { fontSize: 12, fontWeight: '700', color: '#555', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  inputError:  { borderColor: '#E62B4A', backgroundColor: '#FFF5F5' },
  ...
  errorBannerText: { fontSize: 13, color: '#C62828', lineHeight: 20 },
});
